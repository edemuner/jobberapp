...
describe('createConnection', () => {
    ...
    it('connects, creates a channel, logs success, and registers SIGINT cleanup', async () => {
        ...
        expect(mockLog.info).toHaveBeenCalledWith('Auth service connected to queue successfully...');
    ...
    it('logs an error and returns undefined when the connection fails', async () => {
        ...
        expect(mockLog.log).toHaveBeenCalledWith('error', 'AuthService createConnection() method:', error);
    });
});
